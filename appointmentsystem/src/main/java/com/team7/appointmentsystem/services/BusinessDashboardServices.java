...
public class BusinessDashboardServices {
    ...
    public ResponseEntity<String> saveProfile( MultipartFile multipartFile, long businessId) throws IOException
    {
        ...
        String uploadDir = "./business-image/" + businessId;
        ...
        try (InputStream inputStream = multipartFile.getInputStream()) {
            ...
            BusinessImages businessImages = new BusinessImages(business,  filePath.toFile().getAbsolutePath());
            ArrayList<BusinessImages> listOfImages = new ArrayList<>(List.of(businessImages));
            business.setBusinessImages(listOfImages);
